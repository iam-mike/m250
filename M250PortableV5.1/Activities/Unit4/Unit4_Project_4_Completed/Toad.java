...
public class Toad extends OUAnimatedObject
{
   ...
   /**
    * Performs the left behaviour twice..
    */
   ...
   /**
    * Moves the receiver left six places. However because the method does 
    * not send update() to the receiver, the frog does not appear to move 
    * in the Amphibian window.
    */
