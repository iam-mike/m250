 ...
 * and additional methods to initialise and use height.
 *
...
/* Instance variable */
   ...
   /**
    * Constructor for objects of class HoverFrog which has the default 
    * characteristics of a frog and initialises height to 0.
    */
   public HoverFrog()
   {
      super();
...
/* Instance methods */
   ...
   /**
    * If the height of the receiver is greater than 0 decrements the  
    * height of the receiver by 1, otherwise height remains unchanged.
    */
   public void down()
   {
      this.downBy(1);
   ...
   /**
    * If the height of the receiver is less than 6 increments the 
    * height of the receiver by 1, otherwise height remains unchanged.
    */
   public void up()
   {
